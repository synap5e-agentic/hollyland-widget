...
Item {
  ...
  property string pluginName: "Hollyland"
  ...
  property int voiceLevelMin: 0
  property int voiceLevelMax: 5

  property var runActionFn: null
  property var setBooleanActionFn: null
  property var setVoiceLevelFn: null
  property var refreshStateFn: null
  ...
  readonly property var rx: state && state.rx ? state.rx : ({})
  readonly property var audio: state && state.audio ? state.audio : ({})
  readonly property var transmitters: state && state.transmitters ? state.transmitters : []
  ...
  readonly property bool controlsEnabled: !actionBusy
  ...
  function runAction(payload) {
    if (runActionFn) runActionFn(payload);
  }

  function setBooleanAction(action, on, extras) {
    if (setBooleanActionFn) setBooleanActionFn(action, on, extras);
  }

  function setVoiceLevel(value) {
    if (setVoiceLevelFn) setVoiceLevelFn(value);
  }

  function refreshState() {
    if (refreshStateFn) refreshStateFn();
  }

  function updatedLabel() {
    if (!updatedAt) return "Waiting for service";
  ...
  function powerEstimateHeadline(tx) {
    ...
    const estState = estimate.state ? String(estimate.state) : "";
    if (estState === "available") {
      const etaLabel = formatDurationMinutes(estimate.minutes_remaining);
      return etaLabel !== "" ? ("ETA " + etaLabel) : "ETA";
    }
    if (estState === "learning") return "Estimating";
    if (estState === "charging") return "Charging";
    if (estState === "steady") return "Stable";
    if (estState === "unavailable") return "No estimate";
    return "No estimate";
  }
  ...
  Rectangle {
    ...
    ColumnLayout {
      ...
      NBox {
        ...
        RowLayout {
          ...
          ColumnLayout {
            ...
            NText {
              text: root.statusLabel() + "  |  " + root.updatedLabel()
            ...
            ColumnLayout {
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  color: root.audio.noise_enabled !== true ? Color.mPrimary : "transparent"
                  border.width: 1
                  ...
                  NText {
                    ...
                    text: "Off"
                    pointSize: Style.fontSizeS
                    color: root.audio.noise_enabled !== true ? Color.mOnPrimary : Color.mPrimary
                  }
                  ...
                  MouseArea {
                    ...
                    onClicked: root.setBooleanAction("set-noise", false, { level: root.audio.noise_level || 2 })
                  }
                }
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-noise", true, { level: root.audio.noise_level || 2 })
                  }
                }
              }
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  implicitHeight: Math.round(34 * Style.uiScaleRatio)
                  radius: Style.radiusM
                  color: root.audio.light_enabled !== true ? Color.mPrimary : "transparent"
                  border.width: 1
                  border.color: Color.mPrimary
                  opacity: root.controlsEnabled ? 1.0 : 0.6
                  ...
                  NText {
                    ...
                    text: "Off"
                    pointSize: Style.fontSizeS
                    color: root.audio.light_enabled !== true ? Color.mOnPrimary : Color.mPrimary
                  }
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-light", false, null)
                  }
                }
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-light", true, null)
                  }
                }
              }
              ...
              RowLayout {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    implicitHeight: Math.round(34 * Style.uiScaleRatio)
                    radius: Style.radiusM
                    color: (root.audio.voice_mode_name || root.audio.voice_mode) === modelData.value ? Color.mPrimary : "transparent"
                    border.width: 1
                    border.color: Color.mPrimary
                    opacity: root.controlsEnabled ? 1.0 : 0.6
                    ...
                    NText {
                      ...
                      pointSize: Style.fontSizeS
                      color: ((root.audio.voice_mode_name || root.audio.voice_mode) === modelData.value) ? Color.mOnPrimary : Color.mPrimary
                    }
                    ...
                    MouseArea {
                      ...
                      enabled: root.controlsEnabled
                      cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                      onClicked: root.runAction({ action: "set-voice-mode", mode: modelData.value })
                    }
                  }
                }
              }
              ...
              RowLayout {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    implicitHeight: Math.round(34 * Style.uiScaleRatio)
                    radius: Style.radiusM
                    color: (root.audio.eq_level_name || root.audio.eq_level) === modelData.value ? Color.mPrimary : "transparent"
                    border.width: 1
                    border.color: Color.mPrimary
                    opacity: root.controlsEnabled ? 1.0 : 0.6
                    ...
                    NText {
                      ...
                      text: modelData.label
                      pointSize: Style.fontSizeS
                      color: ((root.audio.eq_level_name || root.audio.eq_level) === modelData.value) ? Color.mOnPrimary : Color.mPrimary
                    }
                    ...
                    MouseArea {
                      ...
                      enabled: root.controlsEnabled
                      cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                      onClicked: root.runAction({ action: "set-eq", preset: modelData.value })
                    }
                  }
                }
              }
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setVoiceLevel(Math.max(root.voiceLevelMin, (root.audio.voice_level || 0) - 1))
                  }
                }
                ...
                Rectangle {
                  ...
                  NText {
                    id: valueText
                    anchors.centerIn: parent
                    text: root.displayValue(root.audio.voice_level, "-")
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setVoiceLevel(Math.min(root.voiceLevelMax, (root.audio.voice_level || 0) + 1))
                  }
                }
              }
            }
            ...
            ColumnLayout {
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  implicitHeight: Math.round(34 * Style.uiScaleRatio)
                  radius: Style.radiusM
                  color: root.rx.performance_enabled !== true ? Color.mPrimary : "transparent"
                  border.width: 1
                  border.color: Color.mPrimary
                  opacity: root.controlsEnabled ? 1.0 : 0.6
                  ...
                  NText {
                    ...
                    text: "Off"
                    pointSize: Style.fontSizeS
                    color: root.rx.performance_enabled !== true ? Color.mOnPrimary : Color.mPrimary
                  }
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-performance", false, null)
                  }
                }
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-performance", true, null)
                  }
                }
              }
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  implicitHeight: Math.round(34 * Style.uiScaleRatio)
                  radius: Style.radiusM
                  color: !((root.actionBusy && root.pendingAction === "set-tx-identify")
                       || root.audio.tx_identify_enabled === true) ? Color.mPrimary : "transparent"
                  border.width: 1
                  border.color: Color.mPrimary
                  ...
                  NText {
                    ...
                    pointSize: Style.fontSizeS
                    color: !((root.actionBusy && root.pendingAction === "set-tx-identify")
                         || root.audio.tx_identify_enabled === true) ? Color.mOnPrimary : Color.mPrimary
                  }
                  ...
                  MouseArea {
                    ...
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-tx-identify", false, null)
                  }
                }
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    enabled: root.controlsEnabled && root.canIdentify
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.setBooleanAction("set-tx-identify", true, null)
                  }
                }
              }
              ...
              RowLayout {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    implicitHeight: Math.round(34 * Style.uiScaleRatio)
                    radius: Style.radiusM
                    color: (root.audio.signal_mode_name || root.audio.signal_mode) === modelData.value ? Color.mPrimary : "transparent"
                    border.width: 1
                    border.color: Color.mPrimary
                    opacity: root.controlsEnabled ? 1.0 : 0.6
                    ...
                    NText {
                      ...
                      text: modelData.label
                      pointSize: Style.fontSizeS
                      color: ((root.audio.signal_mode_name || root.audio.signal_mode) === modelData.value) ? Color.mOnPrimary : Color.mPrimary
                    }
                    ...
                    MouseArea {
                      ...
                      enabled: root.controlsEnabled
                      cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                      onClicked: root.runAction({ action: "set-signal-mode", mode: modelData.value })
                    }
                  }
                }
              }
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    MouseArea {
                      ...
                      enabled: root.controlsEnabled
                      cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                      onClicked: root.runAction({ action: "set-shutdown-time", mode: modelData.value })
                    }
                  }
                }
              }
      ...
      RowLayout {
              ...
              RowLayout {
                ...
                Rectangle {
                  ...
                  MouseArea {
                    ...
                    cursorShape: enabled ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.runAction({ action: "set-tx-mute", tx: modelData.id, on: modelData.mute !== true })
                  }
                }
              }
        ...
        NBox {
          visible: root.panelTransmitters.length === 0
          Layout.fillWidth: true
          Layout.alignment: Qt.AlignTop
      ...
      RowLayout {
        ...
        Repeater {
          model: root.panelPowerTransmitters
          ...
          delegate: Rectangle {
            ...
            ColumnLayout {
              ...
              NText {
                visible: batteryCard.subtitleText !== ""
                text: batteryCard.subtitleText
                pointSize: Style.fontSizeXS
                color: Color.mOnSurfaceVariant
              }
              ...
              ColumnLayout {
                ...
                NText {
                  visible: batteryCard.secondaryText !== ""
                  text: batteryCard.secondaryText
                  pointSize: Style.fontSizeXS
                  color: Color.mOnSurfaceVariant
                  wrapMode: Text.Wrap
                }
              ...
              BatteryGraph {
                ...
                estimate: batteryCard.power.estimate
                latestAtMs: root.parseIsoMs(batteryCard.power.latest_at)
        ...
        NBox {
          visible: root.panelPowerTransmitters.length === 0
          Layout.fillWidth: true
          Layout.alignment: Qt.AlignTop
        ...
        NBox {
          ...
          ColumnLayout {
            ...
            GridLayout {
              ...
              NText { text: root.displayValue(root.rx.version); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "Serial"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.rx.sn); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "MAC"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.rx.mac); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "USB"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.rx.usb_dev); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "TX"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText {
                text: root.onlineTransmitters.length > 0
                  ? root.onlineTransmitters.map(function(tx) {
        ...
        NBox {
          ...
          ColumnLayout {
            ...
            GridLayout {
              ...
              NText { text: root.boolText(root.audio.noise_enabled) + "  level " + root.displayValue(root.audio.noise_level, "-"); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "Voice"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.audio.voice_mode_name || root.audio.voice_mode) + "  level " + root.displayValue(root.audio.voice_level, "-"); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "Signal"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.audio.signal_mode_name || root.audio.signal_mode); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "EQ"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.audio.eq_level_name || root.audio.eq_level); pointSize: Style.fontSizeS; color: Color.mOnSurface }

              NText { text: "Shutdown"; pointSize: Style.fontSizeXS; color: Color.mOnSurfaceVariant }
              NText { text: root.displayValue(root.audio.shutdown_time_name || root.audio.shutdown_time); pointSize: Style.fontSizeS; color: Color.mOnSurface }
            }
          }
        }
      }
    ...
    Rectangle {
      ...
      radius: Style.radiusM
      color: Qt.rgba(root.bannerIsError ? Color.mError.r : Color.mPrimary.r,
                     root.bannerIsError ? Color.mError.g : Color.mPrimary.g,
                     root.bannerIsError ? Color.mError.b : Color.mPrimary.b,
                     0.12)
      border.width: 1
      border.color: root.bannerIsError ? Color.mError : Color.mPrimary
      ...
      NText {
        ...
        pointSize: Style.fontSizeXS
        color: root.bannerIsError ? Color.mError : Color.mPrimary
      }
    }
  }
}
